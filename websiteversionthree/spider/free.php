...
<style>
dialog.bar{ display: none; padding:0px; width:200px; height:200px;   overflow: hidden;
...
<script src="js/newPrey.js"></script>
...
<script src="js/web3d/mutateZData.js"></script>
<script src="js/web3d/threeInARow.js"></script>
...
const dataset = [{key: 0, value:[300,300,0,0,0]},{key:1, value:[300,300,300,0,0]},{key:2, value:[300,300,0,300,0]},{key:3,value:[300,300,300,300,0]}];
const querysearch =[];
let clicked = [];
const keywords = [];
let inARow = [];
