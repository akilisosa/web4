...
<script>
  ...
  firebase.initializeApp(config);
    ...
    <script src="js/fire/main.js"></script>
      <script src="js/fire/signIn.js"></script>
...
<div id="userAgreementNotice" style="background-color:beige; position:absolute; top:25vw; left:5vw;" class="d-none">
