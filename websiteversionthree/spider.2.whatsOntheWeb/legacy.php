...
firebase.auth().onAuthStateChanged(function(user) {
  if (user) {
    ...
    document.getElementById("considerSigningUp").hidden = true;


  } else {
    console.log('user is logged out');// No user is signed in.
    document.getElementById('freebtn').disabled = true;
    document.getElementById("considerSigningUp").hidden = false;
  }
});
</script>
    ...
    <div id="considerSigningUp"> Signing up to Sosa Studios lets you use the free version</div>
    <div class=" d-inline row"><a href="free.php"><button id="freebtn" class="btn btn-secondary btn-block ">Free</button></a></div><div class="row"><p>If thats not your thing you can check out the free one.  Free membership has a global search limit of 99.
