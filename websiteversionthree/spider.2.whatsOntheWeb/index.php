...
<section class="align-top"></section>
   ...
   <title>image of a friendly spider</title>
    ...
    <div class="col-md-6"><a id='btnLink'href="legacy.php"><button type="submit" name="signup-submit" class="btn btn-warning float-left d-inline">Learn More</button></a></div>
  </div>
