...
function mutateBottomRightData(numCXVariable,numCYVariable){
        ...
        function addBottomRightCenterBranch(){
            ...
            let bottomRightCenterBranch = [ 0, 0, numCXVariable+300,numCYVariable+300 ];
        ...
        function addBottomRightLeftBranch(){
            ...
            let bottomRightLeftBranch = [0,0,numCXVariable,numCYVariable+300];
            var size = Object.size(dataset);
        ...
        function addBottomRightTopBranch(){
            ...
            let bottomRightTopBranch = [0,0,numCXVariable+300,numCYVariable];
            var size = Object.size(dataset);
        ...
        function checkDatasetThree (){   
           ...
           addBottomRightTopBranch();
            console.log("MUTATE BOTTOM RIGHT DATA COMPLETE");
            return dataset;
        }
